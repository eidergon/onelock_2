 ...
 */
public class aplicativo_otp extends javax.swing.JFrame {

    /**
     * Creates new form poliedro_2
     */
    public aplicativo_otp() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("aplicacion otp");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(aplicativo_otp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aplicativo_otp().setVisible(true);
            }
        });
    }
