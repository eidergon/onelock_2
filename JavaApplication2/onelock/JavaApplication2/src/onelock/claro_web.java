 ...
 */
public class claro_web extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(claro_web.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
