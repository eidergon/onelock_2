 ...
 */
public class nueva_extension extends javax.swing.JFrame {

    /**
     * Creates new form poliedro_2
     */
    public nueva_extension() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("nueva extension");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nueva_extension.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nueva_extension().setVisible(true);
            }
        });
    }
