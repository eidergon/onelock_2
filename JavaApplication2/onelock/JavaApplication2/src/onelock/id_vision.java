 ...
 */
public class id_vision extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(id_vision.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
