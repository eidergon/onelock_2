 ...
 */
public class claro_biometrica extends javax.swing.JFrame {

    /**
     * Creates new form poliedro_2
     */
    public claro_biometrica() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("claro biometrica");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(claro_biometrica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new claro_biometrica().setVisible(true);
            }
        });
    }
