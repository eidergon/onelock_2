 ...
 */
public class extension_otp extends javax.swing.JFrame {

    /**
     * Creates new form poliedro_2
     */
    public extension_otp() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(extension_otp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new extension_otp().setVisible(true);
            }
        });
    }
